...
Tooltip.prototype = {
	...
	setOptions: function(options) {
		this.options = {
			...
			textShadowColor: '#FFF', // Default text shadow color (use CSS value)
	...
	appear: function() {
		...
		var content = new Element("div", { className: "xboxcontent", style: "background-color:" + this.options.backgroundColor + "; border-color:" + this.options.borderColor + 
			...
			((this.options.textShadowColor != '') ? "; text-shadow:1px 1px 2" + this.options.textShadowColor + ";" : "") }).update(this.content);
