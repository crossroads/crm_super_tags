...
describe "admin/customfields/create.js.rjs" do
  ...
  describe "create success" do
    ...
    it "should hide [Create Customfield] form and insert customfield partial" do
      ...
      rendered.should contain(%Q/$("customfield_#{@customfield.id}").visualEffect("highlight"/)
    end
  end

  describe "create failure" do
    it "create (failure): should re-render [create.html.haml] template in :create_customfield div" do
      assign(:customfield, Factory.build(:customfield, :field_label => nil)) # make it invalid
      ...
      rendered.should contain('visualEffect("shake"')
    end
  end
end
